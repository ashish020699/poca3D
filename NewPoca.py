'''
This Code uses NewPoca.txt File containing around 26.4k rows and 5 columns ... 
...
df = pd.read_csv("NewPoca.txt",delimiter = " ",names = headers)
print (df.shape)
...
ax.scatter(xArray,yArray,zArray,s=1,c=aList)#,cmap=cm) 
plt.show()
